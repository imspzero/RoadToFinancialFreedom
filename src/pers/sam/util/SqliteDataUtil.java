...
public class SqliteDataUtil {
	 ...
	 * @return
	 */
	public static List<StockKLinePriceDTO> getDayStockData(String stockCode){
	    ...
	    try {
	        ...
	        ResultSet rs = stmt.executeQuery( "select * from stock_day_data where code='"+stockCode+"' order by day asc;" );
	        while (rs.next()) {
...
//	      }
	 ...
	 * @return
	 */
	public static List<StockKLinePriceDTO> getStock30MinData(
			String stockCode,String beginDay,String endDay){
