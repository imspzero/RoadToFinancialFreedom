...
public class Test300135_day {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		String stockCode ="300135";
		
		List<StockKLinePriceDTO> priceList = GetStockDataFromSqliteUtil.getDayStockData(stockCode,"2016-01-01","2016-03-08");
